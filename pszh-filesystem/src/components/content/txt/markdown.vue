...
export default {
    ...
    methods: {
        ...
        ReadFiles(){
            ...
            DeleteFile(`c:\\${this.fileName}.txt`);
            f1=fso.CreateTextFile(`c:\\${this.fileName}.txt`,true);
            f1.WriteLine(this.content);
            f1.WriteBlankLines(1);
            f1.Close();
            ts=fso.OpenTextFile(`c:\\${this.fileName}.txt`,ForReading);
            s=ts.ReadAll();
            console.log(s);
            ts.Close();
        }
